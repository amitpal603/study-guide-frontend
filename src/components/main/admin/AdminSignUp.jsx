      ...
      <div className='w-full max-w-md'>
        ...
        <div className='bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 transform transition-all duration-500 hover:shadow-pink-300/50 mt-20'>
          ...
          <div className='text-center mb-8'>
            ...
            <h1 className='text-4xl font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent mb-2'>Admin Sign Up</h1>
          ...
          <div className='space-y-5'>
            ...
            <div className='transform transition-all duration-300 hover:translate-x-1'>
              <label className='block'>
                <span className='block text-sm font-semibold text-gray-700 mb-2'>Username :</span>
